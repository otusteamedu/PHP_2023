...
use Vp\App\Validators\Constraints\EmailFormConstraints;
...
class App
{
    ...
    {
        $this->app['constraint.email'] = function () {
            return new EmailFormConstraints();
        };

        $this->app['constraint.emails'] = function () {
            return new EmailsFormConstraints();
        };

        $this->app['constraint.file'] = function () {
            return new FileFormConstraints();
        };
    }
