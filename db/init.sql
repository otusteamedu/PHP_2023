...
INSERT INTO films (title, description, image_preview, teaser_preview) VALUES 
	...
	('Фильм 1', 'DEsc', 'http://path-to-image.ru', 'http://path-to-teaser.ru'),
	('Фильм 2', 'DEsc', 'http://path-to-image.ru', 'http://path-to-teaser.ru'),
	('Фильм 3', 'DEsc', 'http://path-to-image.ru', 'http://path-to-teaser.ru'),
	('Фильм 4', 'DEsc', 'http://path-to-image.ru', 'http://path-to-teaser.ru');
