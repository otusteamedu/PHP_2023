...
INSERT INTO 
    Attributes (name, attribute_type_id) 
VALUES 
    ('рецензии критиков', 2),    
    ('отзыв неизвестной киноакадемии', 2),    
    ('отзыв кинопоиск', 2),  
    ('премия оскар', 4),
    ('премия ника', 4),
    ('мировая премьера', 6),
    ('премьера в РФ', 6),
    ('начала продажи билетов', 6),
    ('запуск рекламы на TВ', 5),
    ('продолжительность фильма', 7),
    ('cлоган', 1),
    ('бюджет', 8),
    ('возраст', 7),
    ('рейтинг', 8);
...
INSERT INTO values VALUES 
    (1, 1, 'Я, Франкенштейн - наиболее типичный представитель одноразовых попкорновых блокбастеров, на который даже не стоит тратить время. Но всем желающим посмотреть на очередную интерпретацию войны Добра со Злом - добро пожаловать. История проста - есть у нас монстр Франкенштейна, который доживает аж до наших дней, есть армия демонов, состоящая из 666 легионов (и это не шутка, в фильме это четко оговаривается), и противостоящая им армия горгулий, с гораздо меньшей численностью, но зато более имбовая в плане способностей и мощи. И разумеется обеим сторонам конфликта очень нужен наш главный герой, который просто хочет спокойной жизни вдали от всего этого.'), -- рецензии критиков
    (1, 3, 'Вот такие дела, вечная проблема злодеев в том, что им нужны живые герои, а не мертвые, что собственно делает антагонистов тупыми и немощными, а героев возвышает до уровня “Бог”. Печально, съешьте печенье, ведь (тут должно было быть слово “фильм”) продолжается.'),
    (1, 6, '2014-01-20'),
    (1, 7, '2014-01-23'),
    (1, 8, '2014-01-10'),
    (1, 9, '2014-01-02'),
...
INSERT INTO values VALUES 
    (2, 1, 'Полтора шпиона - весьма неплохой комедийный боевик, который прекрасно справляется со своей первоочередной задачей, а именно - развлекает зрителя. Всем любителям (или нелюбителям) встреч с бывшими одноклассниками - добро пожаловать.'), -- рецензии критиков
    (2, 3, 'Типичная американская комедия. Полная шуток над которыми не всегда хочется смеяться. Шпионская тема, но растолкована недостаточно. Все события не станут для тебя неожиданностью. Половину фильма просидишь с рукой у лица, а другую половину сам не поймешь, над чем смеешься.'),
    (2, 6, '2016-06-10'),
    (2, 7, '2016-06-15'),
    (2, 8, '2016-06-01'),
    (2, 9, '2016-05-27'),
    (2, 10, '107'),
    (2, 11, 'Они попробуют спасти мир: малыш Харт и скала Джонсон'),
    (2, 12, '50000000'),
    (2, 13, '16');
     

INSERT INTO values VALUES 
    (3, 1, 'Об этом фильме лучше всего говорят сами авторы устами одного из своих персонажей: «Почти 3 часа безудержного самолюбования, заканчивающегося невообразимо плоским финалом». В этой характеристике можно узреть здоровую самоиронию, что, несомненно, достойно повышения итоговой оценки. Но, откровенно говоря, просмотр был скучным.'), -- рецензии критиков
    (3, 3, 'Актеры в лице Тома Хенкса, Холи Бери, и Хью Гранта не спасают. Их актерская игра вымарана калейдоскопным повествованием скучных сюжетов с претензией на лихо закрученную гениальную сказку. Есть чуть-чуть зачем-то вставленного секса (можно было обойтись и без для лучшего рейтинга), есть гей-юноша композитор.'),
    (3, 5, '1'),
    (3, 6, '2021-06-10'),
    (3, 7, '2021-06-15'),
    (3, 8, '2021-06-01'),
