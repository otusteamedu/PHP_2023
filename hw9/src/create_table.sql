...
DROP INDEX IF EXISTS value_film;
DROP INDEX IF EXISTS value_attribute;
...
CREATE TABLE valueAttribute (
    ...
    id_film INT NOT NULL,
     ...
     CREATE INDEX value_film ON valueAttribute (id_film);
     CREATE INDEX value_attribute ON valueAttribute (id_attribute);
