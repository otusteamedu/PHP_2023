...
use Gesparo\HW\Infrastructure\ControllerNavigationStrategy;
...
class App
{
    ...
    {
        return (new ControllerNavigationStrategy($matcher, $request, new StorageStrategy($envManager)))->get()->run();
    }
}
