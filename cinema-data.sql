...
COPY public.films (id, name, length) FROM stdin;
1	Тёща	01:38:00
2	Дворец	01:40:00
3	По щучьему велению	01:55:00
4	Немая ярость 	01:44:00
5	Хоккейные папы	02:11:00
6	Проклятие дудочника 	01:31:00
7	Паранормальные явления: Другое измерение 	01:41:00
8	My SHINee World 	01:51:00
9	Астрал. Сомния 	01:27:00
10	Королевство зверей 	02:08:00
11	Призраки в Венеции	01:43:00
12	Щенячий патруль: Мегафильм	01:32:00
13	Пять ночей с Фредди	01:50:00
\.
...
SELECT pg_catalog.setval('public.films_id_seq', 45, true);
...
SELECT pg_catalog.setval('public.seanses_id_seq', 52, true);
