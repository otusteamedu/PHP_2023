...
insert  into places (hall_id, number_places, number_row, price_modifier) values
    ...
    (3, 2, 2, 0.9),
    (3, 3, 3, 1.2);
insert into movies (producer_id, title, duration, age_rating, user_rating, critic_rating) values
    (1, 'Фильм 1', 150, 17, 8.0, 8.2),
    (2, 'Movie 2', 90, 6, 9.9, 9.9),
    (2, 'Movie 3', 120, 21, 8.2, 8.4),
    (3, 'Movie 4', 86,  17, 6.2, 6.1),
    (3, 'Movie 43', 92, 6, 7.0, 7.0);
insert into movies_countries (movie_id, contry_id) values
	(1, 1),
	(1, 2),
	(2, 2),
	(3, 3),
