...
class GetApplicationFormAction
{
    private ApplicationFormRepositoryInterface $repository;

    public function __construct(ApplicationFormRepositoryInterface $repository)
    {
