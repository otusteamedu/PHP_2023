...
use VKorabelnikov\Hw16\MusicStreaming\Domain\Model\Processing;
use VKorabelnikov\Hw16\MusicStreaming\Application\Storage\DataMapper\ProcessingMapperInterface;
use VKorabelnikov\Hw16\MusicStreaming\Application\Exceptions\TableRowNotFoundException;
use PDOStatement;

class ProcessingMapper implements ProcessingMapperInterface
{
    /**
     * @var \PDO
     */
    ...
    public function __construct(\PDO $pdo)
    {
        ...
        $this->selectByIdStatement = $this->pdo->prepare(
            "SELECT * FROM processing WHERE id=:id"
        );
