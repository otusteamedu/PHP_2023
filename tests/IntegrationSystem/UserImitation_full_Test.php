...
namespace tests\IntegrationSystem;

use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;
use src\UserImitation;

class UserImitation_full_Test extends TestCase
{
...
//            [
//                'whichUser' => 'гость',
//                'expectName' => 'гость',//noname-guest | unknown.. Role::(caption,id) ReadableUI::(caption)
//                'expectGreeting' => 'Приветствуем, гость!'
//                'lang' => 'ru' //@ToDo
//                'systemTypeKey' => 'numb|en|ru' //@ToDo
//            ],
